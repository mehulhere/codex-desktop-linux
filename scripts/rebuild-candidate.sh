...
if [ -f "$REPO_DIR/linux-features/farfield-bridge/verify-build.js" ]; then
    node "$REPO_DIR/linux-features/farfield-bridge/verify-build.js" "$REPORT_DIR/patch-report.json"
fi
