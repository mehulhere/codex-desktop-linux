...
| --- | --- | --- | --- |
| `buildTag` | `patches/feature-build-tag.js` | Shows the running Linux source revision in a centered red `FEATURE BUILD` badge; clicking it opens full build metadata. | `tweaks.buildTag.enabled` |
